...
const SendButton = ({ disabled = false }: { disabled: boolean }) => {
  return (
    <button
      className="absolute p-2 rounded-md bottom-[6px] md:bottom-3 md:p-2 md:right-3 dark:hover:bg-gray-900 dark:disabled:hover:bg-transparent right-2 disabled:text-gray-400 text-white transition-colors disabled:opacity-40 enabled:bg-green-400"
      type="submit"
      disabled={disabled}
    >
      <span>
